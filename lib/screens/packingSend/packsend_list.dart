...
Widget DoccardDefault(
  ...
  title += 'ใบคุม : ' + doclistSend.docNo;

  String subText = 'จำนวน: ' + doclistSend.boxEventCount;

  String subText2 = '     ส่งแล้ว:' + doclistSend.boxSendCount;
  String subText3 = '     ค้างส่ง:' + item_wait.toString();
  String status = "";
  if (item_wait == 0) {
    status = "   Complete";
  } else {
