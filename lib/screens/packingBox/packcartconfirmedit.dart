...
class ConfirmCarteditBox extends StatefulWidget {
  final String docnumber;
  final String docno;
  final int boxnumber;
  const ConfirmCarteditBox(
      {Key? key,
  ...
  @override
  _ConfirmCarteditBoxState createState() => _ConfirmCarteditBoxState();
}

class _ConfirmCarteditBoxState extends State<ConfirmCarteditBox> {
                    ...
                    onSubmit: () {
                      ...
                      if (docdetailState is DocDetailLoadSuccess) {
                        ...
                        context.read<StoreFormCartBloc>()
                          ..add(StoreFormCartPackingBoxUpdate(
                              storePack: storePack));
                      }
                    },
                  ),
