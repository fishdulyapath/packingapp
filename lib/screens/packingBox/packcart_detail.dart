...
class PackcartDetail extends StatefulWidget {
  final String? docnoselect;
  final int status;
  const PackcartDetail(
      {Key? key, required this.docnoselect, required this.status})
      : super(key: key);

  @override
  _PackcartDetailState createState() => _PackcartDetailState();
}
...
class _PackcartDetailState extends State<PackcartDetail> {
