...
class PackBoxListDetail extends StatefulWidget {
  final String docnumber;
  final String docNo;
  final int boxnumber;
  final int status;
  final List<DocDetail> docDetail;
  const PackBoxListDetail(
      {Key? key,
  ...
  @override
  _PackBoxListDetailState createState() => _PackBoxListDetailState();
}

class _PackBoxListDetailState extends State<PackBoxListDetail> {
        ...
        child: Column(
          children: <Widget>[
            Align(
                ...
                child: Text(
                    'รายการสินค้า กล่องที่ ' + widget.boxnumber.toString())),
            SizedBox(
              height: 5,
            ),
